...
void S_StartHealer()
{
	...
	//++CR
	//AddSText(0, 9, TRUE, "Would you like to:", COL_GOLD, FALSE);
	AddSText(0, 8, TRUE, "Would you like to:", COL_GOLD, FALSE);
	//AddSText(0, 12, TRUE, "Talk to Pepin", COL_BLUE, TRUE);
	AddSText(0, 11, TRUE, "Talk to Pepin", COL_BLUE, TRUE);
	//AddSText(0, 14, TRUE, "Receive healing", COL_WHITE, TRUE);
	AddSText(0, 13, TRUE, "Pepin heals for 150 gold", COL_GOLD, FALSE);
	AddSText(0, 14, TRUE, "Receive healing and rest", COL_WHITE, TRUE);
	//--CR
...
void S_StartTavern()
{
	...
	//++CR
	AddSText(0, 15, TRUE, "We have a bed for 80 gold", COL_GOLD, FALSE);
	AddSText(0, 16, TRUE, "Have a night at the Inn", COL_WHITE, TRUE);
	//--CR
...
void S_StartTMorning()
{
	...
	stextsize = 0;
	stextscrl = FALSE;
	AddSText(0, 2, TRUE, "Good Morning!", COL_GOLD, FALSE);
	AddSText(0, 7, TRUE, dayStr, COL_GOLD, FALSE);
	AddSText(0, 10, TRUE, "You wake up and", COL_GOLD, FALSE);
	AddSText(0, 11, TRUE, "ready your stuffs...", COL_GOLD, FALSE);
	AddSText(0, 12, TRUE, "You feel restored...", COL_GOLD, FALSE);
	AddSText(0, 18, TRUE, "Leave the tavern", COL_WHITE, TRUE);
	AddSLine(5);
	storenumh = 20;
}
...
void S_StartHMorning()
{
	...
	AddSText(0, 10, TRUE, "You wake up and", COL_GOLD, FALSE);
	AddSText(0, 11, TRUE, "ready your stuffs...", COL_GOLD, FALSE);
	AddSText(0, 12, TRUE, "You feel perfectly restored...", COL_GOLD, FALSE);
	AddSText(0, 18, TRUE, "Leave the healer house", COL_WHITE, TRUE);
	AddSLine(5);
	storenumh = 20;
}
...
void S_StartGMorning()
{
	...
	if ( true ) {
		...
		AddSText(0, 9, TRUE, "Gillian says:", COL_GOLD, FALSE);
		AddSText(0, 11, TRUE, "Sorry, but we cannot", COL_GOLD, FALSE);
		AddSText(0, 12, TRUE, "host strangers.", COL_GOLD, FALSE);
		AddSText(0, 18, TRUE, "Leave Gillian house", COL_WHITE, TRUE);
		AddSLine(5);
	}
	else {
		PaletteFadeIn(8);
		...
		AddSText(0, 2, TRUE, "Good Morning!", COL_GOLD, FALSE);
		AddSText(0, 7, TRUE, dayStr, COL_GOLD, FALSE);
		AddSText(0, 10, TRUE, "Gillian awake you with", COL_GOLD, FALSE);
		AddSText(0, 11, TRUE, "a kiss on the cheek.", COL_GOLD, FALSE);
		AddSText(0, 12, TRUE, "What a sweet morning!", COL_GOLD, FALSE);
		AddSText(0, 13, TRUE, "You feel restored...", COL_GOLD, FALSE);
		AddSText(0, 18, TRUE, "Leave Gillian house", COL_WHITE, TRUE);
		AddSLine(5);
	}
...
void S_StartFMorning()
{
	...
	if ( random_(33, 100) < 30 ) {
		...
		AddSText(0, 2, TRUE, "The next morning...", COL_GOLD, FALSE);
		AddSText(0, 7, TRUE, dayStr, COL_GOLD, FALSE);
		AddSText(0, 9, TRUE, "Farnham made you drink", COL_GOLD, FALSE);
		AddSText(0, 10, TRUE, "all the night...", COL_GOLD, FALSE);
		AddSText(0, 12, TRUE, "You wake up with", COL_GOLD, FALSE);
		AddSText(0, 13, TRUE, "a headach.", COL_GOLD, FALSE);
		AddSText(0, 14, TRUE, "Farnham is still sleeping.", COL_GOLD, FALSE);
		AddSText(0, 15, TRUE, "You are feeling a bit sick...", COL_GOLD, FALSE);
		AddSText(0, 18, TRUE, "Leave Farnham house", COL_WHITE, TRUE);
		AddSLine(5);
	}
	else {
		...
		AddSText(0, 2, TRUE, "The next morning...", COL_GOLD, FALSE);
		AddSText(0, 7, TRUE, dayStr, COL_GOLD, FALSE);
		AddSText(0, 9, TRUE, "You wake up in the middle", COL_GOLD, FALSE);
		AddSText(0, 10, TRUE, "of garbages.", COL_GOLD, FALSE);
		AddSText(0, 11, TRUE, "Farnham is still sleeping.", COL_GOLD, FALSE);
		AddSText(0, 12, TRUE, "You don't feel", COL_GOLD, FALSE);
		AddSText(0, 13, TRUE, "very much restored...", COL_GOLD, FALSE);
		AddSText(0, 18, TRUE, "Leave Farnham house", COL_WHITE, TRUE);
		AddSLine(5);
	}
...
void S_StartBarMaid()
{
	...
	AddSText(0, 14, TRUE, "Ask a shelter for the night", COL_WHITE, TRUE);
	AddSText(0, 18, TRUE, "Say goodbye", COL_WHITE, TRUE);
	AddSLine(5);
	storenumh = 20;
}
